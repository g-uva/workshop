    ...
    <aside class="home-news-panel">
      ...
      <div class="home-news-scroll">
        <div class="home-news-item">
          ...
          <p>The <a href="{{ '/2026/program/' | relative_url }}">workshop program</a> is now available.</p>
        </div>
        <div class="home-news-item">
          <span class="home-news-date">April 1, 2026</span>
          <p><a href="{{ '/2026/speakers/' | relative_url }}">Speaker details</a> have been added to the website.</p>
        </div>
        <div class="home-news-item">
        ...
        <div class="home-news-item">
          ...
          <p>The paper submission deadline has passed. Submission details remain available on the <a href="{{ '/2026/call-for-papers/' | relative_url }}">Call for Papers</a> page.</p>
        </div>
      </div>
    </aside>
  </div>
